    ...
    <div class="column">
        ...
        <div class="card">
          <div class="card-content">
              <p class="title is-3" align="center">Our Research</p>
          </div>
          <div class="card-image">
              <figure class="image is-16by9">
                <img src="img/horizon.jpeg" alt="horizons">
              </figure>
          </div>
        </div>
        </a>
      ...
      <div class="column">
        <a href="/people_nextdest" >
        <div class="card">
          <div class="card-content">
              <p class="title is-3" align="center">Where are we now?</p>
          </div>
          <div class="card-image">
              <figure class="image is-16by9">
